...
public class ExaminationController {
    ...
    @PostMapping("/add-examination-special/{appointmentId}")
    public ResponseEntity<int[]> addExaminationSpecial(@PathVariable Long appointmentId, @Valid @RequestBody int[] examinations) {
        return ResponseEntity.ok(examinationService.addExaminationSpecial(examinations, appointmentId));
    }
