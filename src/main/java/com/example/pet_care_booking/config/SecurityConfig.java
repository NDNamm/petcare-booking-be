    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity, CustomOidcUserService customOidcUserService, JwtUtils jwtUtils, UserRepository userRepository) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public APIs
                        .requestMatchers("/api/auth/**", "/api/payment/**", "/api/appointment/check-free-time", "/api/forgot-password", "/api/reset-password", "/api/appointment/add/**", "/api/product/product-details/*", "/api/product-review/*").permitAll()
